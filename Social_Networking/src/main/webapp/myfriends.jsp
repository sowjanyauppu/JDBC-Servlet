...
<img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" style="width:72px"></div>
<div class="col-10">
	<div class="card-body">
...
<lottie-player src="https://assets6.lottiefiles.com/packages/lf20_kay5m4bw.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
	 	...
	 	<div><h5>Oh! you don't have any friends...!<br>try to search new friends by clicking <a href="home.jsp">here</a>.</h5></div>
	 <%}%>
	</div>
